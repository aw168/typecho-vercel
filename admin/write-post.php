		  ...
		  <h4 class="card-title"><?php include 'page-title.php'; ?></h4>
			...
			<p class="submit clearfix">
				<span class="right">
					...
					<button type="submit" name="do" value="save" id="btn-save" class="btn-gradient-info btn-sm "><?php _e('保存草稿'); ?></button>
					<button type="submit" name="do" value="publish" class="btn-gradient-info btn-sm " id="btn-submit"><?php _e('发布文章'); ?></button>
