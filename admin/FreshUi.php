<div class="container-scroller">
	...
	<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
		<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
			<a class="navbar-brand brand-logo" href="<?php $options->siteUrl(); ?>"><img src="<?php $options->adminUrl('images/logo.svg'); ?>" alt="logo"></a>
		</div>
		...
		<nav class="sidebar sidebar-offcanvas" id="sidebar">
			<ul class="nav">
				...
				<li class="nav-item sidebar-actions">
					<span class="nav-link">
						<a href="<?php $options->siteUrl(); ?>" class="btn btn-block btn-lg btn-gradient-info" >返回首页</a>
						<a href="<?php $options->logoutUrl(); ?>" class="btn btn-block btn-lg btn-gradient-info">退出登录</a>
						<div class="mt-4">
