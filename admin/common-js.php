...
<script>
$(document).ready(function() {
	if ($(".typecho-logo").length > 0) {
		$("body").css("background", "url('<?php $options->lognimg(); ?>') center no-repeat");
		$(".typecho-logo").html("<a class='navbar-brand brand-logo' href='/index.php' ><img src='<?php $options->adminUrl('images/logo.svg'); ?>' ></a>");
	}
});
</script>
<script src="<?php $options->adminStaticUrl('js', 'theia-sticky-sidebar.min.js?v=' . $suffixVersion); ?>"></script>
<script>
// 边栏滚动插件
jQuery(document).ready(function() {
    var navw = document.body.clientWidth;
    if (navw > 600) {
