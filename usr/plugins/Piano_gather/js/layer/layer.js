...
! function(e, t) {
    ...
    var i, n, a = e.layui && layui.define,
        o = {
            ...
            minLeft: [],
            btn: ["&#x786E;&#x5B9A;", "&#x53D6;&#x6D88;"],
            type: ["dialogs", "page", "iframe", "loading", "tips"],
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], l.SHADE = "layui-layer-shade", l.MOVE = "layui-layer-move", s.pt.config = {
        ...
        if (!t.id || !i("#" + t.id)[0]) {
            ...
            if (e.vessel(f, function(n, r, u) {
                ...
                }).auto(a), 2 == t.type && 6 == r.ie && e.layero.find("iframe").attr("src", s[0]), 4 == t.type ? e.tips() : function() {
    ...
    r.prompt = function(e, t) {
        ...
        var s, l = 2 == e.formType ? '<textarea class="layui-layer-input"' + a + "></textarea>" : function() {
                return '<input type="' + (1 == e.formType ? "text" : "text") + '" class="layui-layer-input">'
            }(),
            f = e.success;
