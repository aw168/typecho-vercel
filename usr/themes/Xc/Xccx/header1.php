...
<a class="item <?php echo $this->is('index') ? 'active' : '' ?>" href="<?php $this->options->siteUrl(); ?>" title="首页" style="margin-right:8px">首页</a>
...
<a class="item <?php echo $this->is('category', $category->slug) ? 'active' : '' ?>" href="<?php $category->permalink(); ?>"><?php $category->name(); ?></a>
<?php else : ?>
<div class="Xc_assort" trigger="hover">
<div class="Xc_assort_link">
<a class="nofollow <?php echo $this->is('category', $category->slug) ? 'active' : '' ?>" href="<?php $category->permalink(); ?>"><?php $category->name(); ?></a>
...
<a class="<?php echo $this->is('category', $child['slug']) ? 'active' : '' ?>" href="<?php echo $child['permalink'] ?>"><?php echo $child['name']; ?></a>
<?php endforeach; ?>
</div>
</div>
<?php endif; ?>
...
<a class="<?php echo $this->is('page', $item['slug']) ? 'active' : '' ?>" href="<?php echo $item['permalink'] ?>"><?php echo $item['title'] ?></a>
<?php endforeach; ?>
</div>
</div>
<?php endif; ?>
...
<?php $children = $category->getAllChildren($category->mid); ?>
<?php if (empty($children)) : ?>
<li><a class="link <?php echo $this->is('category', $category->slug) ? 'current' : '' ?>" href="<?php $category->permalink(); ?>"><?php $category->name(); ?></a></li>
<?php else : ?>
<li>
